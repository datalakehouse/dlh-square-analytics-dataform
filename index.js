...
const V_SQR_DATE_STG = require("./includes/staging/DATE/V_SQR_DATE_STG.js");
...
const W_SQR_DATE_D = require("./includes/master/W_SQR_DATE_D.js");
...
const LOCATION = declare({
  ...
  return {
    ...
    V_SQR_DATE_STG: V_SQR_DATE_STG(params),
    ...
    W_SQR_DATE_D: W_SQR_DATE_D(params),
